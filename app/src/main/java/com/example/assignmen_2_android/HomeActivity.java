...
public class HomeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        androidButton = findViewById(R.id.btn_android_course);
        fullStackButton = findViewById(R.id.btn_full_stack_course);
        iosButton = findViewById(R.id.btn_ios_course);
    ...
    public void onClick(View view) {
        ...
        if(view.getId() == R.id.btn_android_course){
            intent.putExtra("image" , R.drawable.android);
            intent.putExtra("content" , "Part 1 ( Java SE)\n" +
        ...
        }else if (view.getId() == R.id.btn_full_stack_course){
            ...
            intent.putExtra("content" , "OOP refreshment\n" +
                    "• Introduction\n" +
